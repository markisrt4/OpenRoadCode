...
```mermaid
flowchart TD
    css["orc-dark.css / orc-light.css"] --> sheet["StyleSheet"]
    sheet --> gauges["VehicleGaugeTheme"]
    sheet --> shifter["ShifterTheme"]
    sheet --> offroad["OffroadTheme"]
    gauges --> widgets["Tk widgets"]
    shifter --> widgets
    offroad --> widgets
    ...
    class css orcExternal;
    class sheet,gauges,shifter,offroad orcController;
    class widgets orcApp;
```
