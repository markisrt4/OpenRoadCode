(()=>{
  ...
  function install(){
    ...
    if(!document.getElementById('spectrum-display-controls')){
      const card=spectrum.closest('.card'),controls=document.createElement('div');controls.id='spectrum-display-controls';controls.className='mv-spectrum-controls';controls.innerHTML=`<label>SENSITIVITY <span id="spectrum-sensitivity-value">100%</span><input id="spectrum-sensitivity" type="range" min="25" max="200" value="100" step="5"></label>`;
