...
<link rel="stylesheet" href="/web-assets/audio-analysis/music_visualizer.css?v=7">
<div class="card mv-mic-card"><b>Music Analyzer <small class="mv-subtle">SHARED DSP</small></b><p id="music-mic-status">Browser microphone or Linux PipeWire system audio.</p><button id="music-mic-toggle" class="primary wide" data-enabled="0">START MICROPHONE</button></div>
<div id="music-song-card" class="card"><b>NOW HEARING</b><div id="music-song-provider" class="mv-subtle">Checking song recognition…</div><div id="music-song-title" style="font-size:22px;font-weight:900;margin-top:14px">No song identified</div><div id="music-song-artist" style="color:#c0cad4;margin-top:4px">Waiting for recognition</div><div id="music-song-album" class="mv-subtle" style="margin-top:4px">Album metadata will appear here</div><button id="music-song-identify" class="wide" type="button" disabled>IDENTIFY SONG</button><div id="music-song-status" class="mv-subtle" style="margin-top:9px">Loading recognition controller state…</div><span id="music-song-state" style="display:none">CHECKING</span></div>
<div id="music-beat" class="mv-hidden-native"><span id="music-beat-strength">Shared analyzer</span></div>
<div class="card mv-light-card"><div class="mv-section-title">MUSIC LIGHTING</div><div style="height:90px;display:flex;align-items:center;justify-content:center"><div id="music-lightbar" class="mv-lightbar" style="border-radius:999px;background:#17351f"></div></div><p id="music-light-status" class="mv-subtle">Controlled by the shared MusicLighting subsystem.</p></div>
