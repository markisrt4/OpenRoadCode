...
"""Thread-safe cache for public vehicle telemetry consumers."""
...
class VehicleBusSnapshot:
    """Latest vehicle state and bus diagnostics for a telemetry consumer."""
...
class VehicleBusState:
    """Convert vehicle bus messages into a thread-safe domain snapshot."""
