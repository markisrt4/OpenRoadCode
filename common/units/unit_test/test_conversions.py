...
@pytest.mark.parametrize(
    ...
    [
        ...
        (radians_per_second_to_degrees_per_second, math.pi, 180.0),
...
def test_zero_values_remain_zero_where_physically_applicable():
    ...
    assert meters_per_second_squared_to_feet_per_second_squared(0.0) == 0.0
    ...
    assert radians_per_second_to_degrees_per_second(0.0) == 0.0
