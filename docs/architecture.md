...
flowchart LR
    ...
    service["Services / runtime ownership"]
    controller["Controllers / domain behavior"]
    message["Messaging / contracts"]
    adapter["Protocols / hardware boundaries"]
    external["External systems / inputs"]
    ...
    class message orcMessage;
    class adapter orcAdapter;
    class external orcExternal;
```
