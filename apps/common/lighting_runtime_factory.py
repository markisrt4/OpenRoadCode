...
from controllers.lighting import DummyLightingController, LightingControllerIf, UnconfiguredControllerStub
...
from hardware_io.bluetooth.bleak_gatt_transport import BleakGattTransport, BleakUnavailableError
...
def create_lighting_controller(
    *,
    ...
    """Compose one lighting controller for any OpenRoadCode application."""
