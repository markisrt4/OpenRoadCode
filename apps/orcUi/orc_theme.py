...
_MAP_DARK = {
    ...
    "rail": "#5f6d75",
    "path": "#68767d",
    "service_casing": "#3b474d",
    "service": "#87949b",
    "residential_casing": "#435158",
    "residential_road": "#aab7bd",
    "secondary_casing": "#315a70",
    "secondary_road": "#79b5d2",
    "primary_casing": "#125b86",
    "primary_road": "#32a5df",
    "motorway_casing": "#074d77",
    "motorway": ACCENT_BLUE,
    "aeroway": "#68777e",
    "building": "#293338",
    "building_outline": "#4b5960",
    "route_casing": "#f6f8f9",
    "route": "#f0442e",
    "label": "#d6e0e5",
    "label_major": "#f5f8fa",
