...
from apps.orcUi.music_visualizer_panel import MusicVisualizerPanel
...
class OrcUiApp:
    def __init__(self) -> None:
        ...
        self._context_rail=None; self._home_map_panel=None; self._navigation_panel=None; self._radio_panel=None; self._radio_embedder=X11WindowEmbedder(); self._vehicle_panel=None; self._offroad_panel=None; self._media_panel=None; self._music_visualizer_panel=None
    ...
    def _shutdown(self):
        ...
        if self._music_visualizer_panel is not None:self._music_visualizer_panel.close()
    ...
    def _clear_content(self):
        ...
        self._context_rail=self._home_map_panel=self._navigation_panel=self._radio_panel=self._vehicle_panel=self._offroad_panel=self._media_panel=self._music_visualizer_panel=None
    ...
    def _show_music_visualizer_panel(self): self._clear_content(); self._active_nav="VISUALIZER"; self._paint_nav(); self._music_visualizer_panel=MusicVisualizerPanel(self._content,on_back=self._show_home,simulate=True); self._music_visualizer_panel.pack(fill=tk.BOTH,expand=True)
