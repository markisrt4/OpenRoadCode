    ...
    def set_theme_bundle(self, theme: ThemeBundle) -> None:
        ...
        for child in self._controls.winfo_children():
            if isinstance(child, tk.Button):
                child.configure(bg=ui.surface, fg=ui.text, activebackground=ui.control_background, activeforeground=ui.accent_success)
        ...
        self._controls_button.configure(bg=ui.surface, fg=ui.text, activebackground=ui.control_background, activeforeground=ui.accent_success)
        self._paint_groups()
