    ...
    def _build(self) -> None:
        ...
        for label, mode in (
            ...
            transit_menu.add_command(
                label=label,
                command=lambda selected=mode: self._start_poi_search(PoiCategory.TRANSIT, selected),
            )
        ...
        tk.Label(
            guidance,
            textvariable=self._guidance_instruction,
            bg=ui.surface,
            fg=ui.text,
            font=("Sans", 10, "bold"),
            anchor="w",
        ...
        tk.Label(
            guidance,
            textvariable=self._guidance_detail,
            bg=ui.surface,
            fg=ui.text_muted,
            font=("Sans", 8),
            anchor="e",
        ...
        self._follow_button = self._control(controls, "F", self._toggle_follow, ui.accent_success)
        ...
        self._control(controls, "+", lambda: self._change_zoom(1), ui.accent_primary).pack(
