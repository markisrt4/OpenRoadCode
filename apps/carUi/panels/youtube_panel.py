...
from apps.carUi.panels.browser_return_overlay import BrowserReturnOverlay
from controllers.video.youtube_player import (
    DEFAULT_YOUTUBE_URL,
    YouTubePlayer,
)
...
class YouTubePanel(tk.Frame):
    ...
    def __init__(
        ...
        *,
        ...
        self._colors = colors
        self._target = tk.StringVar(value=DEFAULT_YOUTUBE_URL)
