...
class PositionSourceFactoryTest(unittest.TestCase):
    ...
    def test_gpsd_is_default(self, gpsd_source) -> None:
    ...
    def test_browser_uses_configured_address(self, browser_source) -> None:
        with patch.dict(
            os.environ,
            {
        ...
        self.assertIs(result, browser_source.return_value)
