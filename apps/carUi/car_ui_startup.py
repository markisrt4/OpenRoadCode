...
def build_car_ui_dependencies(report:StartupStatusCallback)->CarUiDependencies:
    with ExitStack() as cleanup:
        ...
        music_visualizer=create_music_visualizer_runtime(lighting_controller,spotify_controller);cleanup.callback(music_visualizer.close)
