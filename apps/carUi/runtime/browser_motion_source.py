...
"""CarUi-owned HTTP transport for browser DeviceMotion reports."""
...
class BrowserMotionSource(NavigationSensorIf):
    """Receive browser DeviceMotion reports through an app-owned HTTP server."""
    ...
    def connect(self) -> None:
        ...
        class Handler(BaseHTTPRequestHandler):
            def do_GET(self) -> None:
                ...
                self.send_response(200); self.send_header("Content-Type", "text/html; charset=utf-8"); self.end_headers(); self.wfile.write(_MOTION_PAGE)
            ...
            def do_POST(self) -> None:
                ...
                try:
                    ...
                    sample = BrowserMotionAdapter.sample_from_payload(json.loads(self.rfile.read(length)))
        ...
        self._thread = threading.Thread(target=self._server.serve_forever, name="carui-browser-motion", daemon=True)
        self._thread.start()
