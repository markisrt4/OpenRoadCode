    ...
    return {
        "main": MenuPage(
            ...
            tiles=(
                ...
                MenuTile(
                    "aircraft", "AIRCRAFT", "ADS-B + Airband",
                    "Traffic and chatter",
                ),
                MenuTile(
                    "gauges", "GAUGES", "OBD-II / telemetry",
                    "Vehicle dashboard",
                ),
                MenuTile(
                ...
                MenuTile(
                    "lighting", "LIGHTING", "Cabin / accent",
                    "Lighting controls",
                ),
                MenuTile(
                    "media", "MEDIA", "Spotify / audio",
                    "Music and playback",
                ),
            ),
            columns=3,
        ...
        "radio": MenuPage(
            ...
            tiles=(
                MenuTile(
                    "fm_radio", "FM RADIO", "FM Broadcast radio",
                    "Tune FM stations",
                ),
                MenuTile(
                    "scanner_radio", "SCANNER", "Radio monitoring",
                    "Police / Fire / HAM / GMRS",
                ),
                MenuTile(
                    "weather", "NOAA WX", "Weather radio",
                    "NOAA and alerts",
                ),
            ),
            columns=3,
        ...
        "media": MenuPage(
            ...
            tiles=(
                MenuTile(
                    "spotify", "SPOTIFY", "Streaming control",
                    "Spotify app integration",
                ),
                MenuTile(
                    "netflix", "NETFLIX", "Streaming video",
                    "Netflix browser integration",
                ),
                MenuTile(
                    "youtube", "YOUTUBE", "Video and search",
