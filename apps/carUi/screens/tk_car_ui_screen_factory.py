...
class TkCarUiScreenFactory:
    ...
    def __init__(
        ...
        *,
        compact_ui: bool,
        create_menu_tile,
        show_main_menu: Callable[[], None],
        show_menu: Callable[[str], None],
    ) -> None:
        """Capture the Tk host and application navigation services."""
        self._host = host
    ...
    def create_screens(
        ...
        """Construct Tk screens and connect their presenters and handlers."""
        runtime = dependencies.runtime
        common = {
            "remote_display": runtime.remote_display,
            "on_frequency_changed": on_frequency_changed,
            "create_menu_tile": self._create_menu_tile,
            "binding_factory": create_radio_screen_binding,
        }
        ...
        fm_radio = FMRadioScreen(
            self._host,
            runtime=lambda: runtime.radios.get("fm_radio"),
            back_action=lambda: self._show_menu("radio"),
            **common,
        )
        scanner = ScannerScreen(
            self._host,
            radio_runtimes=runtime.radios,
            radio_menu_action=lambda: self._show_menu("radio"),
        ...
        lighting = LightingScreen(
            ...
            back_action=self._show_main_menu,
        )
        lighting_presenter = LightingPresenter(
            backend=dependencies.lighting_controller,
            lighting_ui=lighting,
            dispatch=dispatch,
        )
        ...
        spotify = SpotifyScreen(
            ...
            image_cache=dependencies.spotify_image_cache,
            lyrics_client=dependencies.spotify_lyrics_client,
            music_video_controller=(
                dependencies.spotify_music_video_controller
            ),
        )
        ...
        offroad_dashboard = OffroadDashboardScreen(
            self._host,
            controller=dependencies.navigation_controller,
            create_menu_tile=self._create_menu_tile,
