...
def _message() -> VehicleStateMessage:
    return VehicleStateMessage(
        ...
        data=VehicleStateData(
            ...
            commanded_throttle_position=None,
            accelerator_pedal_position=0.3,
            engine_load=0.5,
            absolute_engine_load=None,
            fuel_system_status_1=None,
            fuel_system_status_2=None,
            short_term_fuel_trim_bank1=None,
            long_term_fuel_trim_bank1=None,
            ignition_timing_advance_deg=None,
            ...
            fuel_level=0.75,
            fuel_rail_pressure_pa=None,
            commanded_equivalence_ratio=1.0,
            measured_equivalence_ratio=None,
