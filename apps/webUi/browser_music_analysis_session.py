...
class WebBrowserMusicAnalysisSession(MusicAnalysisUiIf):
 def __init__(self,source:PushedPcmMusicAnalysisSource|None=None,*,music_lighting:MusicLightingController|None=None)->None:
  self.source=source or PushedPcmMusicAnalysisSource();self._lock=threading.RLock();self._latest=None;self._ui_state=None;self.presenter=MusicAnalysisPresenter(self.source,music_lighting=music_lighting);self.presenter.attach_ui(self);self.presenter.start()
