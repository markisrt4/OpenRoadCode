...
from apps.webUi.music_lighting_routes import register_music_lighting_routes
...
class _CurrentWebLightingTarget:
    ...
    def set_power(self, enabled):
        return self._session.controller.set_power(enabled)

    def set_color(self, color):
        return self._session.controller.set_color(color)

    def set_brightness(self, percent):
        return self._session.controller.set_brightness(percent)
...
register_music_lighting_routes(app, music_lighting_session)
