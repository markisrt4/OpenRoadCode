...
def tone(frequency_hz: float, sample_rate_hz: int, count: int, amplitude: float) -> np.ndarray:
...
def main() -> int:
    ...
    parser.add_argument("--frequency", type=float, default=60.0, help="test tone frequency in Hz")
