...
@dataclass(frozen=True, slots=True)
class LightingState:
    """Transport state and the most recently requested output settings."""
    connection_status: LightingConnectionStatus = LightingConnectionStatus.DISCONNECTED
    ...
    def __post_init__(self) -> None:
        _validate_range("brightness_percent", self.brightness_percent, 0, 100)
        _validate_range("color_temperature_percent", self.color_temperature_percent, 0, 100)
