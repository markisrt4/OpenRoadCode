...
class NavigationSessionController:
    ...
    def __init__(
        ...
        guidance_controller: RouteGuidanceController,
        reroute_policy: ReroutePolicy,
        *,
        on_route_changed: RouteChangedCallback | None = None,
    ) -> None:
    ...
    def state(self) -> NavigationSessionState | None:
        """Return active navigation context, or None when inactive."""
        return self._state
    ...
    def start(
        ...
        *,
        ...
        """Start navigation, calculating a route when one is not supplied."""
