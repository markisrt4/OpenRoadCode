...
SERVICE_NAME="openroadcode-automotive"
...
[Unit]
Description=OpenRoadCode Automotive Telemetry Service
Requires=openroadcode-message-broker.service
After=openroadcode-message-broker.service network.target bluetooth.service openroadcode-rfcomm0.service
